...
class CustomXLMRobertaModel(nn.Module):
    def __init__(self, num_labels):
        ...
        self.transformer_encoder = nn.TransformerEncoder(nn.TransformerEncoderLayer(d_model=self.xlm_roberta.config.hidden_size, nhead=8), num_layers=4)
...
# output_filename = 'predicted_labels_combined(XLMR_Trans_cmratio).csv'
