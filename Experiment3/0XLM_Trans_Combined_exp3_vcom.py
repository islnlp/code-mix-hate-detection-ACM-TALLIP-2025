...
#Splitting of combined dataset
train_com, val_com = train_test_split(t_com, test_size=0.15, random_state=random_seed, stratify=t_com['Tag'])

max_len = 128  # Maximum sequence length

# Create training, validation, and test datasets

train_dataset = CustomDataset(train_com['Sentence'].values, train_com['Tag'].values, tokenizer, max_len)
...
val_dataset = CustomDataset(val_com['Sentence'].values, val_com['Tag'].values, tokenizer, max_len)
